/*
* Original Repo: https://github.com/leeoniya/RgbQuant.js
...
//		this.sortPal = ['hue-','lum-','sat-'];
	...
	reduce(img, retType, dithKern, dithSerp) {
		if (!this.palLocked)
			this.buildPal();
